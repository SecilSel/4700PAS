...
NetDoping = linspace(1e16,20e16,nx); %linear gradient Nd
% NetDoping = ones(1,nx).*Nd; % doping
%NetDoping = logspace(16,17,nx); %exponantial gradient Nd
x0 = l/2;
nw = l/20;
...
TStop = 14200000*1e-18; %20200000*1e-18
PlDelt = 100000*1e-18;  %160000*1e-18
